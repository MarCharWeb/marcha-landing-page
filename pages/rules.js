                    ...
                    <ul className="space-y-1 list-disc -mt-6 px-24 text-justify">
                        <li><strong className="">Condition to join:</strong>
                            <ul className="pl-4 space-y-1 list-[circle]">
                                ...
                                <li>Workshop: candidates who have successfully made it to Round 2.1 (Top 30).</li>
                                <li>Mentoring Program & Networking Night: candidates who have successfully made it to Round 2.2 (Top 8).</li>
                            </ul>
