...
const AboutUs = ({hideFooter = false}) => {
    ...
    >
      <section id='about-marketing-challengers' className=''>
        <div className="relative w-full py-32 bg-[#2d033f] text-center space-y-8">
          <h1 className="text-tertiary-300 text-display-64 font-semibold mb-4" ref={heroTextRef}>ABOUT MARCHA</h1>
          <div
          ...
          <div className="mx-auto z-[10] space-y-20" style={{ width: '1200px' }}>
            <div className="border border-yellow-400 bg-[#9d29e5] p-6 rounded-lg text-left text-tertiary-300">
              <h3 className="text-lead-24 text-headline-48 mb-4">MARKETING CHALLENGERS</h3>
            ...
            <div className="border border-yellow-400 bg-[#9d29e5] p-6 rounded-lg text-left text-tertiary-300 z-[2]">
              <h3 className="text-lead-24 text-headline-48 mb-4 text-yellow-400">VISION</h3>
            ...
            <div className="border border-yellow-400 bg-[#9d29e5] p-6 rounded-lg text-left text-tertiary-300 z-[2]">
              <h3 className="text-lead-24 text-headline-48 mb-4 text-yellow-400">MISSION</h3>
        ...
        <div className="relative w-full py-32 bg-purple-900 text-center mt-20">
          <h1 className="text-4xl font-semibold text-headline-48 mb-16 text-tertiary-400" style={{ display: 'block' }}>OUR TEAM</h1>
          <TeamCarousel />
