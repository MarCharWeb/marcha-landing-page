...
const partnership = () => {
    return (
        <main className="space-y-1 pt-20 bg-fixed" style={{
            ...
            <p className='font-extrabold lg:text-[27px] text-[25px] my-4 pt-4 text-glow-strong text-center'>JUDGES FOR ROUND 1 & 2</p>
            ...
            <p className='font-extrabold lg:text-[27px] text-[20px] my-4 pt-16 text-glow-strong text-center'>MENTORS</p>
