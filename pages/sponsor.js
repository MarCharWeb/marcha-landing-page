...
<div className="absolute inset-0 flex flex-col items-center justify-center top-[10%] space-y-[-3%] sm:space-y-[-1%] md:space-y-[-3%]  ">
  ...
  <div className="flex justify-center space-x-[5%]">
    <img src="/season13/LOGO/Eni.jpg" alt="Eni" className="max-w-[12%] sm:max-w-[14%] md:max-w-[18%] object-contain" onClick={() => window.open("https://enijobs.vn/", "_blank")}/>
    <img src="/season13/LOGO/Mark.png" alt="Mark" className="max-w-[12%] sm:max-w-[14%] md:max-w-[18%] object-contain" onClick={() => window.open("https://marketingtrips.com/", "_blank")}/>
    <img src="/season13/LOGO/Hi.JPG" alt="Hi" className="max-w-[12%] sm:max-w-[14%] md:max-w-[18%] object-contain" onClick={() => window.open("https://www.facebook.com/p/Hi-Fen-Marketing-61554799268384/", "_blank")}/>
  </div>
</div>
</div>
        </div>
