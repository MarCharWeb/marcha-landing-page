...
import TimePanelleft from "./TimePanelleft";
import TimePanelright from "./TimePanelright";
import TimelinePattern1 from '../assets/timeline-pattern-1.png';
import TimelinePattern2 from '../assets/timeline-pattern-2.png';
...
const Timeline = () => {
    ...
    return (<div className="flex justify-center items-center pt-[2000px]">
