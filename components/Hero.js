...
return ( <header style={{
    ...
    }} className="relative grid grid-cols-1 col-span-1 grid-row-1 row-span-1 z-[10] w-full hero-bg xl:min-h-[1440px] 2xl:min-h-[2000px] h-[1000px] bg-center	bg-cover bg-no-repeat   ">
