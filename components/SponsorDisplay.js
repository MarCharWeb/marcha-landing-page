        ...
        <div>
            <div className="flex flex-col items-center justify-between lg:flex-row">
                ...
                <div className="max-w-[98%] xl:max-w-[80%] flex flex-wrap justify-center gap-5 items-center">
                    {logoList.map((logo, index) => <a key={index} target="_blank" rel="noreferrer"  href={logo.hasOwnProperty("logoLink") ? logo.logoLink: ""} ><ImageHolder  objectFit='fill' className={(logo.hasOwnProperty("logoClassName") ? logo.logoClassName : 'w-20 md:w-28 xl:w-40') + " aspect-4/3"}  src={logo.logoImg}></ImageHolder></a>)} 
                </div>
