...
const Navigation = () => {
  ...
  <a
    ...
    className="nav-item font-bold cursor-pointer focus:outline-none focus:ring-0 border-none"
  >
    CONTACTS
  </a>
</li>
            ...
            {isMenuOpen && (
                <div className="absolute right-0 z-10 mt-5 w-56 origin-top-right bg-black shadow-lg bg-[#0F0616CC] mr-4">
                    <div className="py-1">
                        ...
                        <Link href="/rules">
                            <a className="block px-4 py-2 text-sm text-gray-700 text-center li-hover-effect nav-item" onClick={closeMenu}>TERMS & CONDITIONS</a>
                        </Link>
                    </div>
                </div>
            )}
