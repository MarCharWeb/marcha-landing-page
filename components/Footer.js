const Footer = () => {
    ...
    <section className="flex relative z-[5] flex-col items-start justify-between gap-4 pt-6 xl:items-end xl:flex-row text-small-16 md:text-headline-21 xl:pt-12 pb-4 pl-4">
        ...
        <p className="text-small-16"><span className="font-bold text-primary-500">Sponsor Partnership:</span> marketingchallengers.sponsor@gmail.com</p>
        <p className="text-small-16 mb-10"><span className="font-bold text-primary-500">Media Partnership:</span> marketingchallengers.media@gmail.com</p>

        <p className="text-small-16"><span className="font-bold text-secondary-500 ">Location:</span></p>
        <p className="text-small-16"><span className="font-bold">RMIT Vietnam University - Saigon South campus, 702 Nguyen Van Linh Street, District 7, HCMC</span></p>
        </div>
        ...
        <div className="flex flex-col gap-0.5 xl:pr-8 w-96">
            ...
            <p className="text-small-16 "><span className="font-bold text-primary-500">Project Leader:</span> Ngo Thi Mai Hoa - (+84) 906 528 086</p>
            <p className="text-small-16 mb-5"><span className="font-bold text-primary-500">Media Leader: </span> Tran Thi Minh Anh - (+84) 908 447 888</p>
            
            <p className="text-small-16"><span className="font-bold text-secondary-500"> Follow us on:</span></p>
            <div className="flex items-center gap-4">
                
                 <a target='_blank' rel="noreferrer"  href="https://www.facebook.com/marketing.challengers" className="flex flex-col items-center">
                    ...
                    <span className="text-small-16" >Facebook</span>
                    <span className="text-small-16" >Fanpage</span>
                </a>
                <a target='_blank' rel="noreferrer" href="https://bit.ly/MarChaFacebookGroup" className="ml-2 flex flex-col items-center">
                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M13.8213 22V13H16.5537L17 9H13.8213V7.052C13.8213 6.022 13.8476 5 15.2869 5H16.7447V2.14C16.7447 2.097 15.4925 2 14.2257 2C11.58 2 9.92341 3.657 9.92341 6.7V9H7V13H9.92341V22H13.8213H13.8213Z" fill="#FFFFFF"/>
                    </svg>
                    <span className="text-small-16">Facebook</span>
                    <span className="text-small-16">Group</span>
                </a>
                 <a target='_blank' rel="noreferrer" href="https://www.linkedin.com/company/marketing-challengers/" className="ml-2 flex flex-col items-center place-self-stretch">
                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="text-small-16 mt-3">Linkedin</span>
                </a>
                <a target='_blank' rel="noreferrer" href="https://open.spotify.com/show/2Z04Hb6Ate8xan1p9fALZO" className="ml-2 flex flex-col items-center place-self-stretch">
                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="text-small-16 mt-3">Spotify</span>
